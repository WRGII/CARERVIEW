        ...
        <div className="py-12 lg:py-20 grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <section className="lg:col-span-7 space-y-8">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
              {[
                { icon: <Shield className="w-6 h-6 text-white" />, title: 'Secure Access', desc: 'Token-based authentication with enterprise-grade security', bg: 'from-green-500 to-green-600' },
                { icon: <Users className="w-6 h-6 text-white" />, title: 'Multi-Role Access', desc: 'Dedicated portals for administrators and caregivers', bg: 'from-purple-500 to-purple-600' },
                { icon: <FileCheck className="w-6 h-6 text-white" />, title: 'Standards Compliant', desc: 'ADA/OT aligned assessment standards and protocols', bg: 'from-orange-500 to-orange-600' },
                { icon: <Activity className="w-6 h-6 text-white" />, title: 'Real-time Analytics', desc: 'Comprehensive reporting and data visualization tools', bg: 'from-blue-500 to-blue-600' }
              ].map((f, i) => (
                <div key={i} className="flex items-start gap-4 p-4 bg-white/80 backdrop-blur rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md transition">
                  <div className={`grid place-items-center w-12 h-12 bg-gradient-to-br ${f.bg} rounded-xl shadow-lg`}>{f.icon}</div>
                  <div>
