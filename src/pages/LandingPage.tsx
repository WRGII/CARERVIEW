      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <Card><CardContent>
            ...
            <p className="text-slate-600">All categories, questions, and scoring definitions live in secure database with real-time updates.</p>
          </CardContent></Card>
            ...
            <div className="flex justify-center mb-6">
              <div className="flex bg-slate-100 rounded-lg p-1">
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition ${isSignUp ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-600 hover:text-slate-900'}`}
                >Sign Up</button>
                <button
                  type="button"
