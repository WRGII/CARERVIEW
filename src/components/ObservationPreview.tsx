...
const FILLED_SHADES: Record<number, string> = {
  1: 'bg-peach-blush text-white border-peach-blush',
  2: 'bg-peach-blush/70 text-white border-peach-blush/70',
...
const MUTED_OUTLINES: Record<number, string> = {
  1: 'border-peach-blush/40 text-slate-gray/40 bg-transparent',
  2: 'border-peach-blush/30 text-slate-gray/40 bg-transparent',
  3: 'border-cyan-primary/20 text-slate-gray/40 bg-transparent',
  4: 'border-mint-green/40 text-slate-gray/40 bg-transparent',
  5: 'border-mint-green/40 text-slate-gray/40 bg-transparent',
}
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-xs sm:text-sm text-slate-gray/60 italic">
        ...
        {selectedScore === 4 && ' \u2014 they can manage on their own, but it takes extra time or effort'}
      </p>
    </div>
  )
}
