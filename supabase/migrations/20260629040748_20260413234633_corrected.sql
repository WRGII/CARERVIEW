...
-- ============================================================
  ...
  ('de', 'common', 'policy.priv_s5_title', 'Cookies'),

  ('de', 'common', 'policy.priv_s5_body',
...
-- ============================================================
  ...
  ('sv', 'common', 'policy.priv_s5_title', 'Kakor (cookies)'),

  ('sv', 'common', 'policy.priv_s5_body',
...
-- ============================================================
  ...
  ('fi', 'common', 'policy.priv_s5_title', 'Evästeet'),

  ('fi', 'common', 'policy.priv_s5_body',
