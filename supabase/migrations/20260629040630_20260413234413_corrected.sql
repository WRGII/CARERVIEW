...
-- ============================================================
  ...
  ('es', 'common', 'policy.priv_s5_title', 'Cookies'),

  ('es', 'common', 'policy.priv_s5_body',
...
-- ============================================================
  ...
  ('it', 'common', 'policy.priv_s5_title', 'Cookie'),

  ('it', 'common', 'policy.priv_s5_body',
...
-- ============================================================
  ...
  ('fr', 'common', 'policy.priv_s5_title', 'Cookies'),

  ('fr', 'common', 'policy.priv_s5_body',
