...
INSERT INTO ui_translations (locale, key, value) VALUES
  ...
  ('fr', 'tutorial.step4_body',          'Les Observations vous permettent d''évaluer les activités de la vie quotidiana (AVQ/AIVQ) sur une échelle simple. Au fil du temps, la tendance indique exactement comment les besoins évoluent.'),
