...
const ROUTES = [
  ...
  '/caregiver-resources',
  '/new-carer',
  '/new-carer/big-picture',
  '/new-carer/care-plan',
  '/new-carer/roles',
  '/new-carer/living-arrangements',
  '/new-carer/documents-authority',
  '/new-carer/health-coordination',
  '/new-carer/sustainability',
  '/new-carer/review-plan',
  '/privacy-policy',
  '/data-policy',
]
